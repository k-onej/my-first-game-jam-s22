...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("mgfj-s22",04,b3,93,04),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("mgfj-s22",04,b3,93,04));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("mgfj-s22",04,b3,93,04));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("mgfj-s22",04,b3,93,04))
